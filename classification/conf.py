...
# Data directory
_C.DATA_DIR = "/data/HDD1/hanlei/data/"

# Weight directory
# _C.CKPT_DIR = "./ckpt"
_C.CKPT_DIR = "./classification/ckpt"

# Output directory
_C.SAVE_DIR = "./output"

# Path to a specific checkpoint
_C.CKPT_PATH = "./classification/ckpt/cifar10/corruptions/resnet26_gn.pth"
...
_C.LAME.AFFINITY = "Rknn"#"Rknn"  # "kNN":mean error at 5: 48.78%;   # "rbf"
_C.LAME.KNN = 5  # "Rknn"error at 5:47.02%; 4:46.76%; 3:46.60%; 2:46.53; 1:46.45
_C.LAME.SIGMA = 1.0
...
_C.ROTTA.MEMORY_SIZE = 10
_C.ROTTA.UPDATE_FREQUENCY = 10
_C.ROTTA.gama = 2.0  # return gama * ema_out + stu_out，在cifar和imagenet上都较好
_C.ROTTA.NU = 0.001
_C.ROTTA.ALPHA = 0.1
...
# 更新均值需要的参数
_C.OUR.ALPHA = 0.1
_C.OUR.DECAY_FACTOR = 0.94
_C.OUR.LOWERBOunD = 0.005
...
def get_domain_sequence(ckpt_path):
    ...
    mapping = {"real": ["clipart", "painting", "sketch"],
               ...
               "painting": ["real","clipart","sketch"],
               "sketch": ["real","clipart","painting"],
               }
...
def adaptation_method_lookup(adaptation):
    lookup_table = {"source": "Norm",
                    ...
                    "our": "OUR",
                    "rmt_revise": "RMT_REVISE",
                    "rottamodify": "RoTTAMODIFY",
                    "cottaModify": "CottaModify",
                    "eatamodify": "EATAMODIFY",
                    }
