...
import torchvision
import sys
sys.path.append('/home/tjut_zhanghaiyang/paper-code/CTTA-main/classification/robustbench')
...
from dataset.imagenet_subsets import IMAGENET_A_MASK, IMAGENET_R_MASK, IMAGENET_D109_MASK
...
def get_model(cfg, num_classes):
    if cfg.CORRUPTION.DATASET == "domainnet126":
        ...
        if cfg.CORRUPTION.DATASET == "imagenet_a":  # 200
            base_model = ImageNetXWrapper(base_model, IMAGENET_A_MASK)
        elif cfg.CORRUPTION.DATASET == "imagenet_r":  # 200
            base_model = ImageNetXWrapper(base_model, IMAGENET_R_MASK)
        elif cfg.CORRUPTION.DATASET == "imagenet_d109":  # 109
